...
(function () {
  ...
  css.textContent = [
    ...
    ".ffnav .ffn-brand .mk{width:25px;height:25px;border-radius:7px;background:#e6bd72;display:grid;place-items:center;color:#140d02;font-size:13px;font-weight:900}",
    ...
    ".ffnav a.ffn-link.active::after{content:'';position:absolute;left:12px;right:12px;bottom:2px;height:2px;border-radius:2px;background:#e6bd72}",
    ...
    ".ffnav .ffn-btn-gold{background:#d8a84c;color:#1a1206}",
    ".ffnav .ffn-btn-gold:hover{background:#e6bd72;transform:translateY(-2px)}",
    ...
    ".ffn-brand.dark .mk{width:24px;height:24px;border-radius:7px;background:#e6bd72;display:grid;place-items:center;color:#140d02;font-size:12px;font-weight:900}",
    ...
    ".ffn-d-link:hover{color:#e6bd72}",
    ".ffn-d-link.active{color:#e6bd72}",
