...
- [x] **INFRA-02**: Server audit completed — services, Docker containers, databases, disk usage cataloged per server
...
- [x] **RECOV-02**: Per-server restore documentation — how to rebuild from backup on a fresh server
