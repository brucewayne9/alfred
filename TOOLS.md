...
## 1. CRM (Twenty) — `crm.py`
```
search "name" | list-people [limit] | get-person <id>
...
budget <camp_id> <daily_dollars> - update daily budget (dollars, e.g. 50.00). Shows before/after. Warns if shared budget.
