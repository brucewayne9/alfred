...
### Episode Naming & Numbering

Every episode gets a sequential number and an AI-generated title derived from the transcript. Format: **"Episode 12: The Grind Never Sleeps"**

- Episode number auto-increments from a counter in `processed_files.json` (`"next_episode_number": N`)
- Title is generated by AI after transcription (step 4)
- This naming is consistent across ALL outputs:
  - YouTube: "Episode 12: The Grind Never Sleeps | RuckTalk"
  - WordPress audio page: "Episode 12: The Grind Never Sleeps"
  - WordPress video page: "Episode 12: The Grind Never Sleeps"
  - Blog post: "Episode 12: The Grind Never Sleeps — [SEO-optimized subtitle]"
  - Social clips: "From Episode 12: The Grind Never Sleeps"
  - Telegram notification includes the full episode name and number
...
```
/home/aialfred/rucktalk_pipeline/
    processed_files.json     # Episode Pipeline: which MP4s have been processed + next_episode_number counter
    clip_queue.json          # Episode Pipeline -> Social Engine: queued clips with metadata + episode name/number
...
- Episodes are numbered sequentially and named consistently across all platforms (starting at Episode 4, since 3 episodes were previously processed)
