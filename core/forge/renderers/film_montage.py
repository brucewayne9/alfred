...
def _cut_segment(src: str | Path, seconds: float, out: str | Path) -> Path:
    """Cut `seconds` from a deterministic 10%-in offset (cap 1s), cover-crop to 1080x1920@30, no audio."""
    out = Path(out)
